$(document).ready(function(){
	...
	Obj.prototype.drawStar=function(){     //增加对象原型方法drawStar
	    ...
	    odiv.style.left=Math.floor((document.body.clientWidth-7)*Math.random())+'px';   //div的left值不能超出屏幕的宽度
	    odiv.style.top=Math.floor((document.body.clientHeight-7)*Math.random())+'px';//div的left值不能超出屏幕的高度
	    ...
	    ostar.src='../img/star.png';
	    ostar.style.position='absolute';   //设置img为绝对定位
	    ostar.style.top='0px';
	    ostar.style.opacity='0.8';
